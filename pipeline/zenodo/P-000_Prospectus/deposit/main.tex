...
\textit{In this prospectus, ``constitutional'' refers to system-level governing constraints on permissible transformation within the MO\S{}ES\texttrademark{} ecology---analogous to a constitution's function in a legal order, not exclusively to constitutional law.}
...
\section{The Six-Gate Protocol and MO\S{}ES\texttrademark{} (Operational Layer)}
...
\begin{proposition}[MO\S{}ES\texttrademark{}]
MO\S{}ES\texttrademark{} is the enforcement architecture that instantiates the six-gate protocol. It is the adaptive transmission layer through which CT enters legal, technical, and governance domains. MO\S{}ES\texttrademark{} is protected by U.S.\ Patent Serial No.\ 63/877,177 (Provisional). The law itself is published and open.
\end{proposition}
