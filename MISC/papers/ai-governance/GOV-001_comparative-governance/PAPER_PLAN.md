# GOV-001 — The Only Governance Framework with a Law: Commitment Theory Compared to Constitutional AI, NIST AI RMF, and the EU AI Act
...
- CT is the only AI governance framework grounded in a falsifiable physical law with an empirical record; all existing major frameworks are normative policy documents.
