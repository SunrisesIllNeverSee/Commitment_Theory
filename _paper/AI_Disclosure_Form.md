...
## Cover Information (likely form fields)

| Field | Answer |
|---|---|
| Author Name | Deric J. McHenry |
...
## Q2. What specific tasks did AI perform?
...
## Q4. Did you verify AI-generated content?

> **Yes.** Every case citation, statutory reference, and law-review article cited in the footnotes was independently verified against published sources, including: Proskauer, Debevoise, Akin Gump, Perkins Coie, Morgan Lewis, K&L Gates, Arnold & Porter, and Harvard Law Review legal alerts; Casetext, Justia, Leagle, and FindLaw case-law databases; the published reporters of the underlying law-review articles (Washington L. Rev., Wash. U. L. Rev., Geo. L.J., Calif. L. Rev., Iowa L. Rev.); and the official Thomson Reuters and Anthropic primary-source publications. Where verification required Westlaw or PACER access beyond the author's reach, those items remain flagged in the in-paper Pre-Submission Verification Checklist.
...
## Q6. Web archiving / link rot mitigation

> All ten URLs cited in footnotes 13, 14, 15, 17, 19, 27, and 35 have been archived via perma.cc. Bluebook 22 Pattern B archival format is used throughout: original URL followed by `[https://perma.cc/XXXX-XXXX]`. The two Zenodo citations (fns 36 and 38) use persistent DOI URLs (`https://doi.org/10.5281/zenodo.XXXXX`), which require no additional archiving.

---

## Q7. Conflict of interest / Independence

> The Conservation Law of Commitment referenced in Part VI is the author's own original framework, deposited on Zenodo on March 19, 2026 (DOI: 10.5281/zenodo.18792459). The experimental record (DOI: 10.5281/zenodo.19105225) was deposited contemporaneously. Both deposits **predate** any AI-assisted drafting of this Essay. The author has no financial relationship with any of the AI platforms (Anthropic, OpenAI, DeepSeek, Harvey, Thomson Reuters/CoCounsel, LexisNexis) discussed in the manuscript.

---

## Suggested Final Statement (for the catch-all "Anything else" field)

> Generative AI (DeepSeek and Claude) was used in the drafting process to assist with structuring the legal argument, identifying case law and legal citations, Bluebook formatting, and refining prose. All substantive analysis, the identification of the Heppner/Warner/Morgan doctrinal fracture, the civil rights framing, the proposed functional rule, and the crime-victim gap analysis are the author's own. The author independently verified every case citation against published legal alerts and secondary sources, identified and corrected several AI-generated citation errors before submission, and archived all mutable web sources via perma.cc. The Conservation Law of Commitment referenced in Part VI is the author's original framework, documented in Zenodo preprints (DOIs: 10.5281/zenodo.18792459 and 10.5281/zenodo.19105225) predating any AI-assisted drafting.
...
| Item | Current cite | If unverifiable |
|---|---|---|
