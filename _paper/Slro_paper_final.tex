...
the work or the status of the person performing it. This Essay enters an
empty field. Existing scholarship treats AI as a civil rights threat in
...
strategies, and legal reasoning developed in anticipation of
litigation---not merely the documents in which they are expressed. The
...
lawyers had unique analytical capacity---collapses when the same AI
model generates materially comparable analysis for both. When function
...
staff, government subpoena of stored data, or actual adversarial
access---not the computational inference itself. Treating the potential
for future training or data retention as an immediate waiver of
protection is equivalent to saying that an email
