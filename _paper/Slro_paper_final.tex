...
counsel.\footnote{\emph{See supra} note 12.} For each, AI is the primary
tool for legal preparation. For each, the protection of that preparation
is either absent or ambiguous under current doctrine.
