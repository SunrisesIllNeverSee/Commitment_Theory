...
relevant exposure---beyond ordinary computational processing.\footnote{Courts
  ...
  \emph{see also} Nichol v. City of Springfield, No. 6:14-cv-1983-AA,
  2015 U.S. Dist. LEXIS 169901 (D. Or. Dec. 18, 2015) (extending
  work-product protection to materials prepared by a non-attorney friend
  assisting a pro se litigant in anticipation of litigation).} This
approach builds on decisions that predate the current AI era, including
\emph{Shih v. Petal Card, Inc.}, which held that work-product protection
extends to litigation preparation by a non-attorney corporate
...
language.\footnote{Fed. R. Civ. P. 26(b)(3)(A). The
  ...
  a non-attorney representative); \emph{Nichol}, 2015 U.S. Dist. LEXIS
  169901 (same for non-attorney friend of pro se litigant).}
\emph{Warner} and \emph{Morgan} already take this path. Extending it to
all persons preparing in anticipation of litigation---regardless of
whether they are represented, self-represented, or preparing to
participate as a crime victim in a criminal proceeding---is a doctrinal
development, not a statutory amendment.
